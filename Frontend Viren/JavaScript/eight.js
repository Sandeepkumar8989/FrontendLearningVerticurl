...
//----------------------------Example 2:----------------------------//
    ...
    // returns false as this key is not in the list
        console.log("--------delete----------");
    console.log("delete element with key friend 3 " + map1.delete("friend 3"));
...
countValue3.catch(function()
{
  console.log("we are handling the exception");
})
