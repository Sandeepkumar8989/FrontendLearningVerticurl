...
let new_arr3 = languages.slice(2);
console.log(new_arr3); // [ 'C', 'C++', 'Java' ]
 
// slicing from the second element to fourth element
let new_arr4 = languages.slice(1, 4);
console.log(new_arr4); // [ 'Python', 'C', 'C++' ]
...
let new_arr1 = languages1.slice(0, -1);
console.log(new_arr1); // [ 'JavaScript', 'Python', 'C', 'C++' ]
 
// slicing the array from third-to-last
let new_arr2 = languages.slice(-3);
